...
public class ServiceModule extends BusModBase implements Handler<Message<JsonObject>> {
...
//                                JsonObject sendBack = calculateSummary( message.body().getObject( "notification" ).getArray( "registration_ids" ), helper.getResponse(), helper.getMulticastId() );
                                JsonObject sendBack = calculateSummary( notif.getArray( "registration_ids" ), helper.getResponse(), helper.getMulticastId() );
